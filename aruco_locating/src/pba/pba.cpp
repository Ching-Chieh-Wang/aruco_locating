...
void optWithMarker()
{
    ...
    double tag_size_ = Params::markerSize;  

    // create a marker
    markerslam::BAMarker* tag = new markerslam::BAMarker(tag_size_);
    ...
    //create two keyframe
    markerslam::FramePtr kf1(new markerslam::BAFrame(1));
    kf1->T_w_c_ = Eigen::Matrix4d::Identity();

    markerslam::FramePtr kf2(new markerslam::BAFrame(2));
