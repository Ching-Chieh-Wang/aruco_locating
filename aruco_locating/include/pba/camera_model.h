...
private:
  ...
  double pfx_, pfy_;   // undisort image  k
  double pcx_, pcy_;
...
public:
  ...
  PinholeCamera(double width, double height,
                double fx, double fy, double cx, double cy,
                double pfx, double pfy , double pcx, double pcy,
                double d0=0.0, double d1=0.0, double d2=0.0, double d3=0.0, double d4=0.0 );
  ...
  inline double pfx() const { return pfx_; };
  inline double pfy() const { return pfy_; };
  inline double pcx() const { return pcx_; };
  inline double pcy() const { return pcy_; };
